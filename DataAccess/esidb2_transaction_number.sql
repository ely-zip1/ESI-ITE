...
LOCK TABLES `transaction_number` WRITE;
/*!40000 ALTER TABLE `transaction_number` DISABLE KEYS */;
INSERT INTO `transaction_number` VALUES (1,'000006');
/*!40000 ALTER TABLE `transaction_number` ENABLE KEYS */;
UNLOCK TABLES;
