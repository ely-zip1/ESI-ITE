...
CREATE TABLE `role_membership` (
  ...
  PRIMARY KEY (`id`),
  KEY `role_fk_link_idx` (`role_id`),
  KEY `user_fk_link_idx` (`user_id`),
  CONSTRAINT `role_fk_link` FOREIGN KEY (`role_id`) REFERENCES `roles` (`role_id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  CONSTRAINT `user_fk_link` FOREIGN KEY (`user_id`) REFERENCES `users` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION
